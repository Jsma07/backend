...
exports.crearUsuario = async (req, res) => {
  ...
  try {
    ...
    // Formatea los datos
    nombre =
      nombre.trim().toLowerCase().charAt(0).toUpperCase() +
      nombre.trim().toLowerCase().slice(1);
    apellido =
      apellido.trim().toLowerCase().charAt(0).toUpperCase() +
      apellido.trim().toLowerCase().slice(1);
