  ...
  try {
    ...
    if (
      ...
      return res
        ...
        .json({
          error:
            "Los permisos deben ser un arreglo de números enteros positivos",
        });
    }

    const nuevoRol = await Roles.create({ nombre, EstadoRol: 1 });
    ...
    res
      .status(500)
      .json({ error: "Error interno del servidor al crear el rol" });
  }
};
