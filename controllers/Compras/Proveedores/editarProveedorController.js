...
exports.editarProveedor = async (req, res) => {
  try {
    ...
    if (NIT) {
      ...
      if (existingNIT) {
        return res
          ...
          .json({
            error:
              "El NIT de la empresa que ingresaste ya está registrado para otro proveedor.",
          });
      }
    }
    ...
    if (correo_proveedor) {
      ...
      if (existingCorreo) {
        return res
          ...
          .json({
            error:
              "El correo electrónico ya está registrado para otro proveedor.",
          });
      }
    }
    ...
    if (telefono_proveedor) {
      ...
      if (existingTelefono) {
        return res
          ...
          .json({
            error:
              "El número de teléfono ya está registrado para otro proveedor.",
          });
      }
    }
    ...
    if (direccion_proveedor) {
      ...
      if (existingDireccion) {
        return res
          .status(400)
          .json({
            error: "La dirección ya está registrada para otro proveedor.",
          });
      }
    }
    ...
    if (empresa_proveedor) {
      ...
      if (existingEmpresa) {
        return res
          .status(400)
          .json({
            error: "La empresa ya está registrada para otro proveedor.",
          });
      }
    }
    ...
    res
      .status(200)
      .json({ mensaje: "Proveedor actualizado correctamente", proveedor });
  } catch (error) {
