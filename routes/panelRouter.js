...
const { contarClientes, contarVentas, contarCompras, contarServicios, contarEmpleados, obtenerServiciosMasAgendados, obtenerServicioMasVendido } = require('../controllers/Panel/usuariosTotalesController');
...
routes.get('/api/serviciomasvendido', obtenerServicioMasVendido);
